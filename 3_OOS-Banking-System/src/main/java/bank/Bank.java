...
//1. lesen alle javadoc kommentare
/**
 * Interface for a generic bank. Provides multiple methods to handle the interaction between
 * accounts and transactions.
 */
public interface Bank {                                                     //vertrag, alle methode default public abstract, implements instead of extends
     ...
     */
    void createAccount(String account) throws AccountAlreadyExistsException; //kita gbs terhindar dari error, di java error disebut exception, semua error abcd direpresentasikan oleh class krn java adalah oo, kalo mau buat exc sendiri harus bikin class
